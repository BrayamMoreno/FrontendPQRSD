...
import { BarChart3, ChevronDown, FileText, Home, LayoutDashboard, Settings, Settings2, Users } from "lucide-react"
...
const Navbar: React.FC = () => {
    ...
    const dashboards = permisos.filter(
    ...
    return (
        <header className="fixed top-0 left-0 z-50 w-full shadow-md">
            {/* Primera fila */}
            <div className="w-full bg-[#0A192F]">  {/* Oxford Blue */}
            ...
            {/* Segunda fila */}
            <div className="w-full bg-[#173A5E]"> {/* Un poco más claro que Oxford */}
