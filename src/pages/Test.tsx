...
import { FaSearch, FaFilter, FaFileAlt, FaExclamationTriangle, FaComments, FaThumbsUp, FaEye } from "react-icons/fa"
...
export default function Test() {
    ...
    return (
        <div className="flex min-h-screen min-w-screen bg-gray-100 z-15">

            {/* Sidebar */}
            <div className=" bg-blue-900 fixed left-0 top-0 h-full z-15">
                <Slidebar />
            </div>
                ...
                <div className="max-w-7xl mx-auto p-6">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-sm">Bienvenido, Usuario</span>
                            <div className="w-8 h-8 rounded-full bg-blue-900 flex items-center justify-center text-white">U</div>
                        </div>
                    </div>
