        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-blue-100 rounded-2xl shadow mt-2 p-6 mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between">
            <div>
              ...
              <p className="text-blue-700 text-sm">
                Panel de control para la gestión turística de Girardot
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            ...
            <div className="bg-white rounded-xl shadow p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-600 text-sm">Total Encuestas Completadas</p>
            ...
            <div className="bg-white rounded-xl shadow p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-600 text-sm">Encuestados Colombianos</p>
